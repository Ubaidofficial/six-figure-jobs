...
const securityHeaders = [
  ...
  { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
  {
    ...
    value:
      "default-src 'self'; img-src 'self' https: data:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; connect-src 'self' https:;",
  },
]
...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'prod.builtassets.com' },
