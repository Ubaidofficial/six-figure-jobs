  ...
  return (
    <footer className="bg-[#0A0A0A] border-t border-[#2A2A2A] pt-16 pb-8">
      <div className="container mx-auto px-4">
              ...
              <ul className="space-y-2.5">
                {section.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-[#A1A1A1] text-sm hover:text-[#10B981] transition-colors duration-150"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        {/* Footer Bottom */}
        <div className="border-t border-[#2A2A2A] pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          {/* Copyright */}
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-[#A1A1A1] hover:text-[#10B981] transition-colors"
