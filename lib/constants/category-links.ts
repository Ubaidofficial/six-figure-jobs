...
export const CATEGORY_LINKS = {
  ...
  locations: [
    ...
    { name: 'San Francisco', href: '/jobs/city/san-francisco', count: 0 },
    { name: 'New York', href: '/jobs/city/new-york', count: 0 },
    { name: 'Seattle', href: '/jobs/city/seattle', count: 0 },
    { name: 'Austin', href: '/jobs/city/austin', count: 0 },
    { name: 'Los Angeles', href: '/jobs/city/los-angeles', count: 0 },
  ],
  salaryTiers: [
