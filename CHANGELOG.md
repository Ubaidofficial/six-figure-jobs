...
* **seo:** add staged GSC recovery controls via `SEO_CORE_ONLY` and sitemap caps (jobs shards, company pages, remote URLs), and gate sitemap/robots advertisement to core families during controlled reindex rollouts
...
* **seo:** prevent longtail slice sitemaps from duplicating canonical URLs already owned by priority slices
